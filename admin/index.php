<?php
 ...
 ?>
    ...
    <?php if(isset($_SESSION['add-category-success'])): //shows if add post was successfull ?>
            ...
            <?php elseif(isset($_SESSION['add-post-success'])) : ?>
                ...
                <?php elseif(isset($_SESSION['delete-post-success'])): //shows if edit post was not successfull ?>
                <div class="alert__message success container">
                    <p>
                    ...
                    <table>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><a href="<?php echo ROOT_URL ?>admin/edit-post.php?id=<?php echo $post['id'] ?>" class="btn sm">Edit</a></td>
                                <td><a href="<?php echo ROOT_URL ?>admin/delete-post.php?id=<?php echo $post['id'] ?>" class="btn sm danger">Delete</a></td>
                            </tr>
                            <?php endwhile ?>
                        </tbody>
                    </table>
                    <?php else : ?>
                        <div class="alert__messages error"><?php echo "No posts found." ?></div>
                        <?php endif ?>
                </main>
            </div>
        </section>
