...
if (isset($_POST['submit'])) {
    ...
    if(!$title){
        $_SESSION['edit-post'] = "Couldn't update post. Invalid form data on the title.";
    }elseif(!$category_id){
        $_SESSION['edit-post'] = "Couldn't update post. Invalid form data on category.";
    }elseif(!$body){
        $_SESSION['edit-post'] = "Couldn't update post. Invalid form data on body.";
    }else{
        ...
        //rename image
        $time = time(); //making each image name uique using time
